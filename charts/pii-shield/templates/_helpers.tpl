...
{{ include "pii-shield.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pii-shield.selectorLabels" -}}
...
*/}}
{{- define "pii-shield.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "pii-shield.fullname" .) .Values.serviceAccount.name }}
{{- else }}
